BitcoinPurple Core version *0.15.0.1* is now available from:

  <https://bitcoinpurple.org/bin/bitcoinpurple-core-0.15.0.1/>

and

  <https://bitcoincore.org/bin/bitcoinpurple-core-0.15.0.1/>
