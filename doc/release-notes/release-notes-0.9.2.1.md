BitcoinPurple Core version 0.9.2.1 is now available from:

  https://bitcoinpurple.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 BTCP to 0.01 BTCP
...
- Fix "Start bitcoinpurple on system login"
