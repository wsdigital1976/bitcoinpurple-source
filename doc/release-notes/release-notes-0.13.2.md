BitcoinPurple Core version 0.13.2 is now available from:

  <https://bitcoinpurple.org/bin/bitcoinpurple-core-0.13.2/>
...
- #8908 `4a974b2` Update bitcoinpurple-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow bitcoinpurple-tx to create v2 transactions (btcpdrak)
