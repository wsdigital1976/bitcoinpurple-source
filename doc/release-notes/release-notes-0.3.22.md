Download URL: https://sourceforge.net/projects/bitcoinpurple/files/BitcoinPurple/bitcoinpurple-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 BTCP fee schedule (users still pay 0.01 BTCP per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #bitcoinpurple00 - #bitcoinpurple99
