BitcoinPurple-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/bitcoinpurple/files/BitcoinPurple/bitcoinpurple-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the BitcoinPurple
...
New/changed settings (command-line or bitcoinpurple.conf file)
--------------------------------------------------------
