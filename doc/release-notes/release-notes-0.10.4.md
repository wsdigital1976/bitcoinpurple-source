BitcoinPurple Core version 0.10.4 is now available from:

  <https://bitcoinpurple.org/bin/bitcoinpurple-core-0.10.4/>
...
- #6953 `43c2789` Split bitcoinpurple-tx into its own package
- #6953 `dfe0d4d` Include bitcoinpurple-tx binary on Debian/Ubuntu
