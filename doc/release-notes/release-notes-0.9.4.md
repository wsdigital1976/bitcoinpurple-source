BitcoinPurple Core version 0.9.4 is now available from:

  https://bitcoinpurple.org/bin/0.9.4/
...
this update is incompatible with the BitcoinPurple system and could lead to consensus
forks.

BitcoinPurple Core released binaries from https://bitcoinpurple.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bitcoinpurple/+archive/ubuntu/bitcoinpurple
- A third-party or self-compiled BitcoinPurple Core

upgrade to BitcoinPurple Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
