...
This document provides guidelines for internationalization of the BitcoinPurple Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bitcoinpurple_en.ts` remains unchanged.
