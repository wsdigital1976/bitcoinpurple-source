...
EXCLUDE = [
    # auto generated:
    'src/qt/bitcoinpurplestrings.cpp',
...
EXPECTED_HOLDER_NAMES = [
    r"Satoshi Nakamoto",
    r"The BitcoinPurple Core developers",
    r"BitPay Inc\.",
...
Arguments:
    <base_directory> - The base directory of a bitcoinpurple source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The BitcoinPurple Core developers'
...
Arguments:
    <file> - A source file in the bitcoinpurple repository.
"""
