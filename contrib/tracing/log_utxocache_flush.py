...
"""Example logging BitcoinPurple Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/bitcoinpurpled
...
def main(bitcoinpurpled_path):
    ...
    b = BPF(text=program, usdt_contexts=[bitcoinpurpled_with_usdts])
