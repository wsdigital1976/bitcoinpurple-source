...
complete --command bitcoinpurple-qt --no-files

# Extract options
function __fish_bitcoinpurpleqt_get_options
...
complete \
    --command bitcoinpurple-qt \
    --arguments "(__fish_bitcoinpurpleqt_get_options)"
# Enable file completions only if the commandline now contains a `*.=` style option
complete -c bitcoinpurple-qt \
...
complete \
    --command bitcoinpurple-qt \
    --arguments "(__fish_bitcoinpurpleqt_get_options --nofiles)"
