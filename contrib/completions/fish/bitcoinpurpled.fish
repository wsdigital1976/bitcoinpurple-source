...
complete --command bitcoinpurpled --no-files

# Extract options
function __fish_bitcoinpurpled_get_options
...
complete \
    --command bitcoinpurpled \
    --arguments "(__fish_bitcoinpurpled_get_options)"
# Enable file completions only if the commandline now contains a `*.=` style option
complete --command bitcoinpurpled \
...
complete \
    --command bitcoinpurpled \
    --arguments "(__fish_bitcoinpurpled_get_options --nofiles)"
