...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef BITCOINPURPLE_CHAINPARAMSSEEDS_H\n')
    g.write('#define BITCOINPURPLE_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the bitcoinpurple network\n')
    ...
    g.write('#endif // BITCOINPURPLE_CHAINPARAMSSEEDS_H\n')
