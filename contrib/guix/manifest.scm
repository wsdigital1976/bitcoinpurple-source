...
(define* (make-bitcoinpurple-cross-toolchain target
                                       #:key
...
desirable for building BitcoinPurple Core release binaries."
  ...
  (let ((target (getenv "HOST")))
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list (make-bitcoinpurple-cross-toolchain target)))
