...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/bitcoinpurple/bitcoinpurple/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(BitcoinPurpleTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our bitcoinpurpled node")
