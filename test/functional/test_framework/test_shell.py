...
class TestShell:
    """Wrapper Class for BitcoinPurpleTestFramework.

    The TestShell class extends the BitcoinPurpleTestFramework
    ...
    class __TestShell(BitcoinPurpleTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by BitcoinPurpleTestFramework child class.
            self.num_nodes = 1
