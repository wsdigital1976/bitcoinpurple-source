...
class TestBitcoinPurpleCli(BitcoinPurpleTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `bitcoinpurple-cli getblockchaininfo`")
        ...
        self.log.info("Test -getinfo and bitcoinpurple-cli return all proxies")
        ...
        if self.is_specified_wallet_compiled():
            self.log.info("Test -getinfo and bitcoinpurple-cli getwalletinfo return expected wallet info")
            ...
            assert_equal(Decimal(cli_get_info['Transaction fee rate (-paytxfee) (BTCP/kvB)']), wallet_info['paytxfee'])
            assert_equal(Decimal(cli_get_info['Min tx relay fee rate (BTCP/kvB)']), network_info['relayfee'])
            ...
            # Test bitcoinpurple-cli -generate.
            n1 = 3
            n2 = 4
            ...
            # Test bitcoinpurple-cli -generate with -rpcwallet in multiwallet mode.
