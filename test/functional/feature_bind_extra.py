...
"""
Test starting bitcoinpurpled with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(BitcoinPurpleTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that bitcoinpurpled has bound on "::1" (for RPC) and "::" (for P2P).
