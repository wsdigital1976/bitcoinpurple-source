...
# TestP2PConn: A peer we use to send messages to bitcoinpurpled, and store responses.
...
class CompactBlocksTest(BitcoinPurpleTestFramework):
    ...
    # This test actually causes bitcoinpurpled to (reasonably!) disconnect us, so do this last.
    ...
    # bitcoinpurpled's choice of nonce.
    ...
    # Test that bitcoinpurpled requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for bitcoinpurpled to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        node = self.nodes[0]
        # bitcoinpurpled will not send blocktxn responses for blocks whose height is
