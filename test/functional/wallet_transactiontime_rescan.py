...
class TransactionTimeRescanTest(BitcoinPurpleTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine BTCP and create transactions
        ...
        # generate some btcp to create transactions and check blockcount
