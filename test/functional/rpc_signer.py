...
Verify that a bitcoinpurpled node can use an external signer command.
...
class RPCSignerTest(BitcoinPurpleTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart bitcoinpurpled with -signer=<cmd>',
