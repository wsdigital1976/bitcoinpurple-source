...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the BitcoinPurpleTestFramework
    pass


class ExampleTest(BitcoinPurpleTestFramework):
    # Each functional test is a subclass of the BitcoinPurpleTestFramework class.
    ...
    def custom_method(self):
        ...
        BitcoinPurpleTestFramework class so other tests can use it."""
