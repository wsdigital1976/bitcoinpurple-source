...
By default, bitcoinpurpled will dump mempool on shutdown and
...
class MempoolPersistTest(BitcoinPurpleTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent bitcoinpurpled from writing mempool.dat to disk. Verify that `savemempool` fails")
