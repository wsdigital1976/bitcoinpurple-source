...
"""Verify that starting bitcoinpurple with -h works as expected."""

from test_framework.test_framework import BitcoinPurpleTestFramework
from test_framework.util import assert_equal

class HelpTest(BitcoinPurpleTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bitcoinpurple with -h for help text")
        ...
        self.log.info("Start bitcoinpurple with -version for version information")
        ...
        self.log.info("Start bitcoinpurpled with -fakearg to make sure it does not start")
