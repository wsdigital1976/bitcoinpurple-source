...
class NetTest(BitcoinPurpleTestFramework):
    ...
    def test_getnodeaddresses(self):
        ...
        self.nodes[0].addpeeraddress(address=ipv6_addr, port=13496)
        ...
        for i in range(10000):
            ...
            self.nodes[0].addpeeraddress(a, 13496)
    ...
    def test_addpeeraddress(self):
        ...
        assert_equal(node.addpeeraddress(address="", port=13496), {"success": False})
