...
#ifndef BITCOINPURPLE_IPC_PROCESS_H
#define BITCOINPURPLE_IPC_PROCESS_H
...
//! IPC process interface for spawning bitcoinpurple processes and serving requests
...
#endif // BITCOINPURPLE_IPC_PROCESS_H
