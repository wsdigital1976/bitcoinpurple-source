...
#ifndef BITCOINPURPLE_COMPAT_ASSUMPTIONS_H
#define BITCOINPURPLE_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "BitcoinPurple cannot be compiled without assertions."
#endif
...
#endif // BITCOINPURPLE_COMPAT_ASSUMPTIONS_H
