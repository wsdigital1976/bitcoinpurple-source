...
#ifndef BITCOINPURPLE_UTIL_SYSCALL_SANDBOX_H
#define BITCOINPURPLE_UTIL_SYSCALL_SANDBOX_H
...
//!
//! SetupSyscallSandbox(...) is called during bitcoinpurpled initialization if BitcoinPurple Core was compiled
...
#endif // BITCOINPURPLE_UTIL_SYSCALL_SANDBOX_H
