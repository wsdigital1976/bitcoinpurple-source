...
#ifndef BITCOINPURPLE_UTIL_SETTINGS_H
#define BITCOINPURPLE_UTIL_SETTINGS_H
...
//!       https://github.com/bitcoinpurple/bitcoinpurple/pull/15934/files#r337691812)
...
#endif // BITCOINPURPLE_UTIL_SETTINGS_H
