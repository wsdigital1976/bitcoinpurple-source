...
#ifndef BITCOINPURPLE_UTIL_MESSAGE_H
#define BITCOINPURPLE_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's bitcoinpurple address, it must refer to a public key.
...
#endif // BITCOINPURPLE_UTIL_MESSAGE_H
