...
#ifndef BITCOINPURPLE_INTERFACES_NODE_H
#define BITCOINPURPLE_INTERFACES_NODE_H
...
//! Top-level interface for a bitcoinpurple node (bitcoinpurpled process).
class Node
{
public:
    virtual ~Node() {}
    ...
    //! Return setting value from <datadir>/settings.json or bitcoinpurple.conf.
...
#endif // BITCOINPURPLE_INTERFACES_NODE_H
