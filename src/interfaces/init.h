...
#ifndef BITCOINPURPLE_INTERFACES_INIT_H
#define BITCOINPURPLE_INTERFACES_INIT_H
...
//! (bitcoinpurple-gui, bitcoinpurple-node, bitcoinpurple-wallet, bitcoinpurpled, bitcoinpurple-qt) and each
...
#endif // BITCOINPURPLE_INTERFACES_INIT_H
