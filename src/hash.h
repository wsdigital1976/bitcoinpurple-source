...
#ifndef BITCOINPURPLE_HASH_H
#define BITCOINPURPLE_HASH_H
...
/** A hasher class for BitcoinPurple's 256-bit hash (double SHA-256). */
class CHash256 {
private:
    CSHA256 sha;
public:
...
/** A hasher class for BitcoinPurple's 160-bit hash (SHA-256 + RIPEMD-160). */
class CHash160 {
private:
    CSHA256 sha;
public:
