...
#ifndef BITCOINPURPLE_SCRIPT_STANDARD_H
#define BITCOINPURPLE_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a bitcoinpurple address
 */
...
/**
 * Generate a BitcoinPurple scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // BITCOINPURPLE_SCRIPT_STANDARD_H
