...
#ifndef BITCOINPURPLE_SCRIPT_SCRIPT_H
#define BITCOINPURPLE_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, BitcoinPurple always counted CHECKMULTISIGs
...
#endif // BITCOINPURPLE_SCRIPT_SCRIPT_H
