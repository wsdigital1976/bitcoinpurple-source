...
#ifndef BITCOINPURPLE_SCRIPT_MINISCRIPT_H
#define BITCOINPURPLE_SCRIPT_MINISCRIPT_H
...
//! Parse a miniscript from a bitcoinpurple script
...
#endif // BITCOINPURPLE_SCRIPT_MINISCRIPT_H
