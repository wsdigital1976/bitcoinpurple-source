...
#ifndef BITCOINPURPLE_NET_H
#define BITCOINPURPLE_NET_H
...
public:
     ...
     * @see https://github.com/bitcoinpurple/bitcoinpurple/issues/21744 for details.
     */
