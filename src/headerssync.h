...
#ifndef BITCOINPURPLE_HEADERSSYNC_H
#define BITCOINPURPLE_HEADERSSYNC_H
 ...
 *
 * The BitcoinPurple protocol does not offer an easy way to determine the work on a
...
#endif // BITCOINPURPLE_HEADERSSYNC_H
