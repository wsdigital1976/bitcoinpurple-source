...
{
    BOOST_CHECK(TestSplitHost("www.bitcoinpurplecore.org", "www.bitcoinpurplecore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.bitcoinpurplecore.org]", "www.bitcoinpurplecore.org", 0));
    BOOST_CHECK(TestSplitHost("www.bitcoinpurplecore.org:80", "www.bitcoinpurplecore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.bitcoinpurplecore.org]:80", "www.bitcoinpurplecore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("127.0.0.1:13496", "127.0.0.1", 13496));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:13496", "127.0.0.1", 13496));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:13496", "::ffff:127.0.0.1", 13496));
    BOOST_CHECK(TestSplitHost("[::]:13496", "::", 13496));
    BOOST_CHECK(TestSplitHost("::13496", "::13496", 0));
    BOOST_CHECK(TestSplitHost(":13496", "", 13496));
    BOOST_CHECK(TestSplitHost("[]:13496", "", 13496));
    ...
    BOOST_CHECK(TestSplitHost("www.bitcoinpurplecore.org:65536", "www.bitcoinpurplecore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.bitcoinpurplecore.org:0", "www.bitcoinpurplecore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.bitcoinpurplecore.org:", "www.bitcoinpurplecore.org:", 0, false));
}
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:13496", "127.0.0.1:13496"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:13496", "[::]:13496"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
