...
#ifndef BITCOINPURPLE_TEST_SCRIPTNUM10_H
#define BITCOINPURPLE_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from BitcoinPurple Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // BITCOINPURPLE_TEST_SCRIPTNUM10_H
