...
#ifndef BITCOINPURPLE_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define BITCOINPURPLE_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // BITCOINPURPLE_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
