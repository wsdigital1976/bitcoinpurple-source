...
#ifndef BITCOINPURPLE_QT_GUIUTIL_H
#define BITCOINPURPLE_QT_GUIUTIL_H
...
/** Utility functions used by the BitcoinPurple Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "bitcoinpurple:" URI into recipient object, return true on successful parsing
...
#endif // BITCOINPURPLE_QT_GUIUTIL_H
