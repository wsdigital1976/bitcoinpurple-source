...
#ifndef BITCOINPURPLE_QT_SENDCOINSDIALOG_H
#define BITCOINPURPLE_QT_SENDCOINSDIALOG_H
...
/** Dialog for sending bitcoinpurples */
...
#endif // BITCOINPURPLE_QT_SENDCOINSDIALOG_H
