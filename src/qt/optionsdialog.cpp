      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->bitcoinpurpleAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->bitcoinpurpleAtStartup);
    ...
    ui->bitcoinpurpleAtStartup->setToolTip(ui->bitcoinpurpleAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->bitcoinpurpleAtStartup->setText(ui->bitcoinpurpleAtStartup->text().arg(PACKAGE_NAME));

    ui->openBitcoinPurpleConfButton->setToolTip(ui->openBitcoinPurpleConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new BitcoinPurpleUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->bitcoinpurpleAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSBTCPontrols);
...
void OptionsDialog::on_openBitcoinPurpleConfButton_clicked()
{
    ...
    if (!GUIUtil::openBitcoinPurpleConf())
