...
{
    // Test regression https://github.com/bitcoinpurple/bitcoinpurple/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/bitcoinpurple-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/bitcoinpurple-core/gui/pull/568.
    // With fListen=false in ~/.config/BitcoinPurple/BitcoinPurple-Qt.conf and all else left as default,
    // bitcoinpurple-qt should set both -listen and -listenonion to false and start successfully.
