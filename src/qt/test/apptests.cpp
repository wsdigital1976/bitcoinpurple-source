...
//! Entry point for BitcoinPurpleApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &BitcoinPurpleApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for BitcoinPurpleGUI tests.
void AppTests::guiTests(BitcoinPurpleGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &BitcoinPurpleGUI::consoleShown, this, &AppTests::consoleTests);
