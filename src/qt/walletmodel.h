...
#ifndef BITCOINPURPLE_QT_WALLETMODEL_H
#define BITCOINPURPLE_QT_WALLETMODEL_H
...
/** Interface to BitcoinPurple wallet from Qt view code. */
...
#endif // BITCOINPURPLE_QT_WALLETMODEL_H
