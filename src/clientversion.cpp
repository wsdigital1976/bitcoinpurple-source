 ...
 * for both bitcoinpurpled and bitcoinpurple-qt, to make it harder for attackers to
...
/**
 * Format the subversion field according to BIP 14 spec (https://github.com/bitcoinpurple/bips/blob/master/bip-0014.mediawiki)
 */
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/bitcoinpurple/bitcoinpurple>";
