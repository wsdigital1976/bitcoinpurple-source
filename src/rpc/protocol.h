...
#ifndef BITCOINPURPLE_RPC_PROTOCOL_H
#define BITCOINPURPLE_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in bitcoinpurpled
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< BitcoinPurple is not connected
...
#endif // BITCOINPURPLE_RPC_PROTOCOL_H
