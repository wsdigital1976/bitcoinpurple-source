...
#ifndef BITCOINPURPLE_CRYPTO_CHACHA_POLY_AEAD_H
#define BITCOINPURPLE_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@bitcoinpurple.
 *
 ...
 *
 * The chacha20-poly1305@bitcoinpurple combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@bitcoinpurple cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@bitcoinpurple are relatively fast in
...
#endif // BITCOINPURPLE_CRYPTO_CHACHA_POLY_AEAD_H
