...
#ifndef BITCOINPURPLE_WALLET_WALLETUTIL_H
#define BITCOINPURPLE_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! bitcoinpurple from opening the wallet, thinking it was newly created, and
...
#endif // BITCOINPURPLE_WALLET_WALLETUTIL_H
