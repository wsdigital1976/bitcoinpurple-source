...
#ifndef BITCOINPURPLE_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define BITCOINPURPLE_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // BITCOINPURPLE_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
