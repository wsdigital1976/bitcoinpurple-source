...
#ifndef BITCOINPURPLE_WALLET_SCRIPTPUBKEYMAN_H
#define BITCOINPURPLE_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The BitcoinPurple Core wallet was originally a collection of unrelated private
...
#endif // BITCOINPURPLE_WALLET_SCRIPTPUBKEYMAN_H
