...
#ifndef BITCOINPURPLE_WALLET_TRANSACTION_H
#define BITCOINPURPLE_WALLET_TRANSACTION_H
...
public:
     ...
     * on this bitcoinpurple node, and set to 0 for transactions that were created
...
#endif // BITCOINPURPLE_WALLET_TRANSACTION_H
