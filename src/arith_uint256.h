...
#ifndef BITCOINPURPLE_ARITH_UINT256_H
#define BITCOINPURPLE_ARITH_UINT256_H
...
public:
     ...
     *
     * BitcoinPurple only uses this "compact" format for encoding difficulty
...
#endif // BITCOINPURPLE_ARITH_UINT256_H
